...
All three layers must be defeated simultaneously to bypass the guardrails. Layer 2 and 3 are not controlled by Claude — they're enforced by the Claude Code runtime and shell scripts.
